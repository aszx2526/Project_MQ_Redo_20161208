...
public class onMQ_AnimControll_09_Boom : MonoBehaviour {
    ...
    public void myMQAnimController()
    {
        ...
        {
            case 0:
                myAniam.Play("BombAttack");
                break;
            case 1:
                myAniam.Play("BombBasic");
                break;
            case 2:
                myAniam.Play("BombCharge_loop");
                break;
            case 3:
                myAniam.Play("BombHit");
                break;
            case 4:
                myAniam.Play("BombRotation");
                break;
            default:
                break;
        }
